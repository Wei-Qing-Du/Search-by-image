...
#=======================================================================
#Get a image
def get_one_image(train,label):# Train is a path
   # n = len(train)
...
def evaluate_one_image(image_array):
    with tf.Graph().as_default():
       ...
       with tf.Session() as sess:
           ...
           if max_index >= 0:
               print('This is a roses with possibility %d' %max_index)
#------------------------------------------------------------------------
...
if __name__ == '__main__':
    ...
    img = get_one_image(r"C:\Users\Z97MX-GAMING\Desktop\train\3_3875.jpg",3)  #通过改变参数train or val，进而验证训练集或测试集
    #print(str(img))
